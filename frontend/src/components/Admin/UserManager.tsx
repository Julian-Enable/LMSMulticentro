        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between sticky top-0 bg-white dark:bg-slate-800">
              ...
              <button onClick={handleCancel} className="p-2 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-lg transition-colors">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full px-3 py-2.5 border border-gray-200 dark:border-slate-600 rounded-lg text-sm bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-slate-100 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all cursor-text"
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <span className={`text-sm font-semibold ${formData.isActive ? 'text-primary-700 dark:text-primary-400' : 'text-gray-500 dark:text-slate-400'}`}>
            ...
            <div className="p-6 border-t border-gray-200 dark:border-slate-700 flex gap-3 justify-end sticky bottom-0 bg-white dark:bg-slate-800 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
              <button
                onClick={handleCancel}
                className="px-6 py-3 rounded-lg border-2 border-gray-300 dark:border-slate-600 text-gray-700 dark:text-slate-300 text-sm font-bold hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
              >
                Cancelar
              </button>
              <button
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-gray-200 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all"
          />
        </div>
        <button
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gradient-to-r from-primary-600/5 to-purple-50 dark:from-primary-900/20 dark:to-slate-800 border-b-2 border-primary-600/20 dark:border-primary-800/30">
              <tr>
                <th className="px-6 py-4 text-left text-xs font-extrabold text-primary-700 dark:text-primary-400 uppercase tracking-wider">Usuario</th>
                <th className="px-6 py-4 text-left text-xs font-extrabold text-primary-700 dark:text-primary-400 uppercase tracking-wider">Email</th>
                <th className="px-6 py-4 text-center text-xs font-extrabold text-primary-700 dark:text-primary-400 uppercase tracking-wider">Rol</th>
                <th className="px-6 py-4 text-center text-xs font-extrabold text-primary-700 dark:text-primary-400 uppercase tracking-wider">Fecha Creación</th>
                <th className="px-6 py-4 text-center text-xs font-extrabold text-primary-700 dark:text-primary-400 uppercase tracking-wider w-32">Acciones</th>
              </tr>
            </thead>
              ...
              {filteredUsers.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center">
                    ...
                    <p className="text-gray-600 dark:text-slate-400 font-medium">No se encontraron usuarios</p>
                  </td>
                </tr>
              ) : (
                filteredUsers.map((user) => (
                  <tr key={user.id} className="hover:bg-blue-50/30 dark:hover:bg-slate-700/30 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className={`font-bold text-sm ${user.isActive === false ? 'text-gray-500 dark:text-slate-500 line-through' : 'text-gray-900 dark:text-slate-100'}`}>{user.username}</span>
